...
type IncubateLogicContentProps = {
...
function IncubateLogicContent({
    ...
    isSlotAnimatingOpen,
}: IncubateLogicContentProps) {
    const isPending = pendingJobElement !== null;
    return (
        <div className="incubate-logic-content">
            <div
                className={[
...
export default IncubateLogicContent;
